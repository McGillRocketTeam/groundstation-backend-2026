 ...
 * <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;<a href=
 * "https://labjack.com/support/software/api/ljm">https://labjack.com/support/software/api/ljm</a><br>
 * <p>
 ...
 * For example:<br>
 * <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;Pointer stringPtr = new
 * Memory(100);&nbsp;&nbsp;//Allocates 100 bytes of memory which is a 100
 * character C string.
 * </ul>
 * 
 * <p>
...
public class LJM {
	...
	public class Constants {
		 ...
		 */
		@Deprecated
		public static final int UDP_PORT = 52362;
		/**
		 * @deprecated Maximum packet size should instead be read
		 *             with {@link #getHandleInfo}
		 */
		@Deprecated
		public static final int MAX_TCP_PACKET_NUM_BYTES_T7 = 1040;
		/**
		 * @deprecated Maximum packet size should instead be read
		 *             with {@link #getHandleInfo}
		 */
		 ...
		 */
		@Deprecated
		public static final String SPECIAL_ADDRESSES_FILE = "LJM_SPECIAL_ADDRESSES_FILE";
		/**
