...
/**
 * Instances of this interfaces are run on the incoming MQTT messages to
 * transform them to TM packets
 */
public interface MqttToTmPacketConverter {
	...
	/**
	 * Converts an incoming MQTT message to an iterable collection of TmPacket
	 * objects.
	 * <p>
	 * The implementation is responsible for setting the reception time and the data
	 * part of each TmPacket. Other fields
	 * in the TmPacket are optional and can be left unpopulated.
	 * <p>
	 * The returned {@code Iterable} may yield no elements if the message cannot be
	 * converted.
	 * 
	 * @param message
